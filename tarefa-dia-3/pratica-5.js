...
let vendas = receita.reduce((acc, { valor }) => acc + valor, 0)
console.log(`Total de Vendas: R$: ${vendas}`)

/* PROBLEMA 2: Qual o valor total de vendas incluindo a gorjeta? --------------- */
//COLOQUE SUA SOLUÇÃO AQUI
let gorjetas = receita.reduce((acc, { gorjeta }) => acc + gorjeta, 0)
console.log(`Total de Gorjetas: R$ ${gorjetas}`)

let ven_gorje = vendas + gorjetas
console.log(`Total de Vendas + Gorjetas: R$ ${ven_gorje}`)

console.log()

/* PROBLEMA 3:  Quantas vendas foram abaixo de 50 reais?----------------------- */
//COLOQUE SUA SOLUÇÃO AQUI
let vlr = receita.filter((receita) => receita.valor < 50)
console.log(`Vendas abaixo de R$ 50: ${vlr.length}`) // Saída: 4
console.log(vlr)
